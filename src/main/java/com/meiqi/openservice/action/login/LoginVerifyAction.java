...
public class LoginVerifyAction extends BaseAction{
	    ...
	    try {
            ...
            if(object!=null){
                ...
                if(memcacheService.getCache(key)==null || memcacheService.getCache(sessionIdLoginKey)==null){
                    ...
                    putCookieAndMemcache(request, response, repInfo, result, userId, key, isAutoLoginKey);
                }
	...
	public void putCookieAndMemcache(HttpServletRequest request,HttpServletResponse response, RepInfo repInfo,Map<String, Object> result, String userId,String key,String isAutoLoginKey){
