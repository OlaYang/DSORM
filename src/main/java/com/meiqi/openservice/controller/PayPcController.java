                ...
                if (trade_status.equals("TRADE_FINISHED") || trade_status.equals("TRADE_SUCCESS")) {
                    ...
                    if (paying.get(key) == null) {
                        ...
                        if ("success".equals(payResult)) {
                        	SendMessageBonusThread sendMessageBonusThread=new SendMessageBonusThread(request, response, out_trade_no);
                        	SendMessageOrderConfirm sendMessageOrderConfirm=new SendMessageOrderConfirm(request, response, result);
