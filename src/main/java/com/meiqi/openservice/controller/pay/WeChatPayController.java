...
import com.meiqi.openservice.threads.SendMessageBonusThread;
import com.meiqi.openservice.threads.SendMessageOrderConfirm;
...
//		}
        ...
        if("SUCCESS".equals(resultJsonObject.getString("return_code"))){
        	SendMessageBonusThread sendMessageBonusThread=new SendMessageBonusThread(request, response, ourOrderSn);
        	SendMessageOrderConfirm sendMessageOrderConfirm=new SendMessageOrderConfirm(request, response, resultJsonObject);
        	new Thread(sendMessageBonusThread).start();
        	new Thread(sendMessageOrderConfirm).start();
        }
