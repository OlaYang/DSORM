...
public class UpmpCore {
	...
	public static Map<String, String> paraFilter(Map<String, String> para) {
		...
		for (String key : para.keySet()) {
			...
			if (value == null || value.equals("") || key.equalsIgnoreCase(UpmpConfig.SIGNATURE) || key.equalsIgnoreCase(UpmpConfig.SIGN_METHOD)) {
				continue;
			}
	...
	public static String buildSignature(Map<String, String> req) {
		...
		prestr = prestr + QSTRING_SPLIT + UpmpMd5Encrypt.md5(UpmpConfig.UPMP_TEST ? UpmpConfig.SECURITY_KEY_TEST : UpmpConfig.SECURITY_KEY);
