...
public class HttpUtil {
    ...
    public static void get(GetMethod get) throws Exception {
        try {
            int result = httpClient.executeMethod(get);
            String response = IOUtil.streamToString(get.getResponseBodyAsStream());
            LOG.debug("get responseBody:" + response);
            if (result != 200) {
