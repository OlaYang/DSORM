...
public final class NetWorkCenter {
    ...
    public static BaseResponse post(String url, String paramData,ApiConfig config) {
        ...
        response[0].verifyWechatResponse(true, config);
        return response[0];
    }
    ...
    public static BaseResponse post(String url, String paramData, List<File> fileList,ApiConfig config) {
        final BaseResponse[] response = new BaseResponse[]{null};
    ...
    public static BaseResponse get(String url,ApiConfig config) {
        final BaseResponse[] response = new BaseResponse[]{null};
