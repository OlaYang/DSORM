package com.meiqi.liduoo.fastweixin.company.message.resp;

import java.util.ArrayList;
import java.util.List;

import com.meiqi.liduoo.fastweixin.company.message.QYArticle;
import com.meiqi.liduoo.fastweixin.message.Article;
import com.meiqi.liduoo.fastweixin.message.RespType;
