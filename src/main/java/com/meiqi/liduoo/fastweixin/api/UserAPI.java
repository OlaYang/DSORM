...
public class UserAPI extends BaseAPI {
     ...
     * @return 调用结果
     */
    public BaseResponse setUserRemark(String openid, String remark) {
     ...
     * @return 调用结果
     */
    public BaseResponse updateGroup(Integer groupid, String name) {
     ...
     * @return 调用结果
     */
    public BaseResponse moveGroupUser(String openid, String toGroupid) {
        BeanUtil.requireNonNull(openid, "openid is null");
     ...
     * @return 调用结果
     */
    public BaseResponse moveGroupUser(String[] openids, String toGroupid) {
