...
public class MenuAPI extends BaseAPI {
	 ...
	 * @return 调用结果
	 */
	public BaseResponse createMenu(Menu menu) {
		BeanUtil.requireNonNull(menu, "menu is null");
		String url = BASE_API_URL + "cgi-bin/";
		if (BeanUtil.isNull(menu.getMatchrule())) {
			// 普通菜单
			LOG.debug("创建普通菜单.....");
			url += "menu/create?access_token=#";
		} else {
			// 个性化菜单
			LOG.debug("创建个性化菜单.....");
			url += "menu/addconditional?access_token=#";
		}
	 ...
	 * @return 调用结果
	 */
	public BaseResponse deleteMenu() {
		LOG.debug("删除菜单.....");
	 ...
	 * @since 1.3.7
	 */
	public BaseResponse deleteConditionalMenu(String menuId) {
