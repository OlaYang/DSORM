 ...
 */
public class _W_GROUP_UPDATE extends WeChatFunction {
	public static final String NAME = _W_GROUP_UPDATE.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		final String groupName = DataUtil.getStringValue(args[3]);

		ApiConfig config = WeChatUtils.initApiConfig(appId, appSecret);
		UserAPI api = new UserAPI(config);

		BaseResponse result = api.updateGroup(groupid, groupName);
