 ...
 */
public class _W_DC_USER_READ extends WeChatFunction {
	public static final String NAME = _W_DC_USER_READ.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUserReadResponse summary = noCache ? null : (GetUserReadResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUserReadResponse result = api.getUserRead(beginDate, endDate);
