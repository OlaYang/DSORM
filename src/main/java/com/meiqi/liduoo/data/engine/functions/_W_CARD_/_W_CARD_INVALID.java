 ...
 */
public class _W_CARD_INVALID extends WeChatFunction {
	public static final String NAME = _W_CARD_INVALID.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		final String cardId = DataUtil.getStringValue(args[3]);

		ApiConfig config = WeChatUtils.initApiConfig(appId, appSecret);
		CardAPI api = new CardAPI(config);

		BaseResponse result = api.invalid(code, cardId);
