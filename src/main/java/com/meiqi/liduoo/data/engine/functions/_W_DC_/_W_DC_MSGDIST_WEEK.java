 ...
 */
public class _W_DC_MSGDIST_WEEK extends WeChatFunction {
	public static final String NAME = _W_DC_MSGDIST_WEEK.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUpstreamMsgDistWeekResponse summary = noCache ? null
				: (GetUpstreamMsgDistWeekResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUpstreamMsgDistWeekResponse result = api.getUpstreamMsgDistWeek(beginDate, endDate);
