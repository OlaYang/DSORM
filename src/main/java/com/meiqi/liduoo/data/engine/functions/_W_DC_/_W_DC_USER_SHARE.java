 ...
 */
public class _W_DC_USER_SHARE extends WeChatFunction {
	public static final String NAME = _W_DC_USER_SHARE.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUserShareResponse summary = noCache ? null : (GetUserShareResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUserShareResponse result = api.getUserShare(beginDate, endDate);
