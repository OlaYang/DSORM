 ...
 */
public class _W_MESSAGE_SENDTOGROUP extends WeChatFunction {
	public static final String NAME = _W_MESSAGE_SENDTOGROUP.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		final String groupId = DataUtil.getStringValue(args[4]);
		...
		GetSendMessageResponse result = api.sendMessageToGroup(baseMsg, groupId, false);
