 ...
 */
public class _W_CUSTOM_ADDACCOUNT extends WeChatFunction {
	public static final String NAME = _W_CUSTOM_ADDACCOUNT.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		BaseResponse result = api.addCustomAccount(customAccount);
