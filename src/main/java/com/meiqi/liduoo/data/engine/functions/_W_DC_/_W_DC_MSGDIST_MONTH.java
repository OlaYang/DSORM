 ...
 */
public class _W_DC_MSGDIST_MONTH extends WeChatFunction {
	public static final String NAME = _W_DC_MSGDIST_MONTH.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUpstreamMsgDistMonthResponse summary = noCache ? null
				: (GetUpstreamMsgDistMonthResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUpstreamMsgDistMonthResponse result = api.getUpstreamMsgDistMonth(beginDate, endDate);
