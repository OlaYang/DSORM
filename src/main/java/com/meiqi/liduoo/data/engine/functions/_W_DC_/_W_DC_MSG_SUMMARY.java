 ...
 */
public class _W_DC_MSG_SUMMARY extends WeChatFunction {
	public static final String NAME = _W_DC_MSG_SUMMARY.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUpstreamMsgResponse summary = noCache ? null : (GetUpstreamMsgResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUpstreamMsgResponse result = api.getUpstreamMsg(beginDate, endDate);
