 ...
 */
public class _W_DC_MSGDIST extends WeChatFunction {
	public static final String NAME = _W_DC_MSGDIST.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUpstreamMsgDistResponse summary = noCache ? null : (GetUpstreamMsgDistResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUpstreamMsgDistResponse result = api.getUpstreamMsgDist(beginDate, endDate);
