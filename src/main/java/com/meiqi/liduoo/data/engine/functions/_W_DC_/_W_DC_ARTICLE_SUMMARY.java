 ...
 */
public class _W_DC_ARTICLE_SUMMARY extends WeChatFunction {
	public static final String NAME = _W_DC_ARTICLE_SUMMARY.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetArticleSummaryResponse summary = noCache ? null : (GetArticleSummaryResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetArticleSummaryResponse result = api.getArticleSummary(day);
