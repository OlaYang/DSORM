 ...
 */
public class _W_CARD_DECRYPTCODE extends WeChatFunction {
	public static final String NAME = _W_CARD_DECRYPTCODE.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		final String encryptCode = DataUtil.getStringValue(args[2]);

		ApiConfig config = WeChatUtils.initApiConfig(appId, appSecret);
		CardAPI api = new CardAPI(config);

		CardDecryptCodeResponse result = api.decryptCode(encryptCode);
