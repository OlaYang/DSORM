 ...
 */
public class _W_DC_MSG_WEEK extends WeChatFunction {
	public static final String NAME = _W_DC_MSG_WEEK.class.getSimpleName();
	...
	public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
		...
		GetUpstreamMsgWeekResponse summary = noCache ? null : (GetUpstreamMsgWeekResponse) CacheUtils.getCache(key);
		if (summary == null) {
			...
			GetUpstreamMsgWeekResponse result = api.getUpstreamMsgWeek(beginDate, endDate);
