 ...
 */
public class _O_JSONBYPARA2 extends Function {
    public static final String NAME = _O_JSONBYPARA2.class.getSimpleName();
    ...
    public Object eval(CalInfo calInfo, Object[] args) throws RengineException, CalculateError {
        ...
        if (result == null) {
            result = _O_JSON.init2(calInfo, serviceName, currentParam
