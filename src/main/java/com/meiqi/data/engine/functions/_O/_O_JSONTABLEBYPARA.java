...
public class _O_JSONTABLEBYPARA extends Function {
    ...
    static String init(CalInfo calInfo, String serviceName, Map<String, Object> currentParam
            , boolean needAllBoolean, boolean isDbLangZH, boolean needFilter, boolean returnTypeBoolean, String funcName) throws RengineException, CalculateError {
    ...
    private static List<Map<String, String>> data2Rows(D2Data data, List<TServiceColumn> columnsNeed
            , boolean needAll
