...
public class _O_JSON extends Function {
    ...
    static String init2(CalInfo calInfo, String serviceName, Map<String, Object> current
        ...
        for (int i = 0; i < args.size(); i++) {
            ...
            for (int j = 0; j < value.length; j++) {
                ...
                if (colCalValue == null) {
                	...
                	try{
                		collist.add(JSONObject.parse(colCalValue.toString()));
                	}catch(Exception e){
            ...
            size = collist.size();
            if(1==size){
            	map.put(args.get(i), collist.get(0));
            }else{
