...
public class RANKSTR extends Function {
    static final String NAME = RANKSTR.class.getSimpleName();
    ...
    private Map<String, Long> init(ExcelRange range, int order, boolean isPassEmpty) throws RengineException, CalculateError {
