 ...
 */
// 针对nextDB轮训的数据库id配置
public class TServiceNextDBConfig implements Serializable {
    /**
	 * 
	 */
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TServiceNextDBConfig)) return false;

        TServiceNextDBConfig that = (TServiceNextDBConfig) o;
