...
@Service("solrActionImpl")
public class SolrActionImpl implements ISolrAction {
            ...
            if(StringUtils.isNotEmpty(facetFields)){
                ...
                if (ListUtil.notEmpty(docs)) {
                    ...
                    if ("1".equals(istimely)) {
                        ...
                        String data = dataAction.getData(dsReqInfo,"");
                        ...
                        if (lits != null && lits.size()>0) {
                            Map<String, String> maps = lits.get(0);
                                ...
                                String data1 = dataAction.getData(dsReqInfo1,"");
